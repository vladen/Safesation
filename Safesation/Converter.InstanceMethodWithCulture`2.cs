...
namespace Safesation
{
    ...
    {
        private sealed class InstanceMethodWithCulture<TSource, TTarget>
            : Converter<TSource, TTarget>
        {
            #region CONSTRUCTORS

            public InstanceMethodWithCulture(MethodInfo method)
                : base(ConversionFeatures.Culture, ConversionWays.InstanceMethod)
            {
