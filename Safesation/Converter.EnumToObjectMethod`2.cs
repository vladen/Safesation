...
namespace Safesation
{
    ...
    {
        private sealed class EnumToObjectMethod<TSource, TTarget>
            : Converter<TSource, TTarget>
        {
            #region CONSTRUCTORS

            public EnumToObjectMethod()
            ...
            protected override Delegate Build()
            {
                ...
                il.Emit(OpCodes.Call, Types.Enum.GetMethod("ToObject", new[] { Types.Type, SourceType }));
