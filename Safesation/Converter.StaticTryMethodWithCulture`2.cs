...
namespace Safesation
{
    ...
    {
        private sealed class StaticTryMethodWithCulture<TSource, TTarget>
            : Converter<TSource, TTarget>
        {
            #region CONSTRUCTORS

            public StaticTryMethodWithCulture(MethodInfo method)
                : base(ConversionFeatures.Culture, ConversionWays.StaticTryMethod)
            {
