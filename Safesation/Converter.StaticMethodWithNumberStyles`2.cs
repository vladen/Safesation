...
namespace Safesation
{
    ...
    {
        private sealed class StaticMethodWithNumberStyles<TSource, TTarget>
            : Converter<TSource, TTarget>
        {
            #region CONSTRUCTORS

            public StaticMethodWithNumberStyles(MethodInfo method)
                : base(ConversionFeatures.Styles, ConversionWays.StaticMethod)
            {
