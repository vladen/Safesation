...
namespace Safesation
{
    ...
    {
        private sealed class StaticTryMethodWithFormatAndCulture<TSource, TTarget>
            : Converter<TSource, TTarget>
        {
            #region CONSTRUCTORS

            public StaticTryMethodWithFormatAndCulture(MethodInfo method)
                : base(ConversionFeatures.CultureFormat, ConversionWays.StaticTryMethod)
            {
