...
namespace Safesation
{
    ...
    {
        private sealed class StaticMethod<TSource, TTarget>
            : Converter<TSource, TTarget>
        {
            #region CONSTRUCTORS

            public StaticMethod(MethodInfo method)
                : base(Categorize(method.Name), ConversionFeatures.None, ConversionWays.StaticMethod)
            {
