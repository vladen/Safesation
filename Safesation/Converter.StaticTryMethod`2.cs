...
namespace Safesation
{
    ...
    {
        private sealed class StaticTryMethod<TSource, TTarget>
            : Converter<TSource, TTarget>
        {
            #region CONSTRUCTORS

            public StaticTryMethod(MethodInfo method)
                : base(ConversionFeatures.None, ConversionWays.StaticTryMethod)
            {
